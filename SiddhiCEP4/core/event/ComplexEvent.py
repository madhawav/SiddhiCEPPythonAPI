...
from SiddhiCEP4.DataTypes.DataWrapper import unwrapData, wrapData


class ComplexEvent(object):
    class Type(Enum):
        CURRENT = SiddhiLoader.loadType("org.wso2.siddhi.pythonapi.proxy.core.event.complex_event.TypeProxy")().CURRENT(),
        EXPIRED = SiddhiLoader.loadType("org.wso2.siddhi.pythonapi.proxy.core.event.complex_event.TypeProxy")().EXPIRED(),
        TIMER = SiddhiLoader.loadType("org.wso2.siddhi.pythonapi.proxy.core.event.complex_event.TypeProxy")().TIMER(),
        RESET = SiddhiLoader.loadType("org.wso2.siddhi.pythonapi.proxy.core.event.complex_event.TypeProxy")().RESET()
    ...
    def getOutputData(self):
        complex_event_static_proxy = SiddhiLoader.loadType("org.wso2.siddhi.pythonapi.proxy.core.event.complex_event.ComplexEventProxy")()
    ...
    def setOutputData(self, datum, index):
        ...
        complex_event_static_proxy = SiddhiLoader.loadType(
    ...
    def getType(self):
        ...
        type_proxy = SiddhiLoader.loadType("org.wso2.siddhi.pythonapi.proxy.core.event.complex_event.TypeProxy")(raw_type_proxy)
